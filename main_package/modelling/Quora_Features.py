...
def words_to_vectors(fs1, filename):
    ...
    for index, row in fs1.iterrows():
        ...
        q1_word = (list)(filter(lambda word: word in Quora_word2vec.vocab, row['question1_tokens'].split(',')))
        q2_word = (list)(filter(lambda word: word in Quora_word2vec.vocab, row['question2_tokens'].split(',')))
        ...
        Distance_Functions(Quora_word2vec, fs1, index, q1_vector, q2_vector, row['question1_tokens'],
                           row['question2_tokens'], num_features)
